...
namespace LiveEventWithTranscription
{
    class Program
    {
        ...
        private static async Task RunAsync(ConfigWrapper config)
        {
            ...
            try
            {
                ...
                transcriptionList.Add(new LiveEventTranscription(language: "en-US"));   // Set transcription language

                LiveEvent liveEvent = new LiveEvent(
                    location: mediaService.Location,
                    description: "Sample LiveEvent for .Net",
                    vanityUrl: false,
                ...
                LiveOutput liveOutput = new LiveOutput(assetName: asset.Name, manifestName: manifestName, archiveWindowLength: TimeSpan.FromHours(25)); //, description: "Sample LiveOutput for .Net");
                ...
                if (await PrintPaths(client, config.ResourceGroup, config.AccountName, streamingLocatorName, streamingEndpoint))
                {
                    ...
                    Console.WriteLine("The LiveOutput and LiveEvent are now deleted.");
                }
            }
            ...
            StreamingEndpoint streamingEndpoint)
        {
            ...
            if (stringBuilder.Length > 0)
            {
                ...
                Console.WriteLine("Open Azure Media Player at https://ampdemo.azureedge.net/");
                Console.WriteLine("In the Setup tab, copy/paste one of the above urls to the URL field and check Advanced Options.");
                Console.WriteLine("Then click Add Captions Track, type en-US in Caption Locale TextBox and click Update Player.");
                Console.WriteLine("Make sure you have turned on the Closed Captioning in the Media Player.");
                Console.WriteLine();
                return true;
            }
            else
